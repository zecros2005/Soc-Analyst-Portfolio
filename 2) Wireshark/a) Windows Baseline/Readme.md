...
This baseline is the first part of a Wireshark project. A separate PCAP was later created for Kali-to-Windows reconnaissance activity.
...
Normal / legitimate user and OS activity
...
Network Baseline / Protocol Analysis
...
Limited Microsoft/Windows-related HTTP

Normal

TLS

YouTube TLS handshake observed

Normal encrypted traffic

QUIC

Encrypted QUIC sessions observed

Normal modern web traffic
...
Echo request/reply observed

Normal connectivity testing

TCP

Normal three-way handshake(s)

No unusual reset pattern

UDP

DNS/QUIC/NTP/DHCP traffic
